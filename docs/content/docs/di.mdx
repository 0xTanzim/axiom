...
| | |
|---|---|
| ✅ Zero boilerplate | ✅ Automatic dependency resolution |
| ✅ Clean project structure | ⚠️ Classpath scanning at startup |
  </Tab>
...
| | |
|---|---|
| ✅ 100% explicit | ✅ No reflection |
| ✅ Instant startup | ⚠️ More boilerplate |
  </Tab>
</Tabs>
...
INFO  🚀 Axiom running on http://0.0.0.0:8080
```
